package com.allelink.wzyx.utils.regex;
...
public class RegexUtils {
    ...
    /**
     * 验证密码
     * <p>取值范围为a-z,A-Z,0-9,用户名必须是6-20位</p>
     *
     * @param input 待验证文本
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isAuthCode(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_AUTH_CODE, input);
    }
    /**
     * 判断是否匹配正则
     *
